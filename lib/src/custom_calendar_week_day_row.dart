...
class CustomWeekdayRow extends StatelessWidget {
  const CustomWeekdayRow(this.firstDayOfWeek, this.customWeekdayBuilder,
      {Key? key,
    ...
    return customWeekdayBuilder != null
        ...
        : Expanded(
            ...
            decoration: BoxDecoration(
              border: Border.all(color: weekdayBackgroundColor ?? Colors.white),
              color: weekdayBackgroundColor ?? Colors.white,
            ),
                ...
                child: Padding(
                  ...
                  child: Text(
                    ...
                    style: weekdayTextStyle!
                        .copyWith(color: weekdayTextColor ?? Colors.black87),
                  ),
                ),
              ),
            ),
